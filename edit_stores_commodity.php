...
<main class="main-content p-5">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <h1 class="m-0 fs-5">
            ...
            <a class="mx-5 fs-1" href="add_stores_commodity.php?stores_id=<?= $_GET['stores_id'] ?>"><i class="fa-regular fa-square-plus" style="color: #FFD43B;"></i></a>
        </h1>
        <!-- button用div包起來 -->
        <ul class="nav nav-underline fs-5">
            ...
            <li class="nav-item mx-3">
                <a class="nav-link text-success" href="edit_stores_commodity.php?stores_id=<?= $_GET['stores_id'] ?>">修改空間數量</a>
            </li>
        </ul>
    </div>
    <hr />
